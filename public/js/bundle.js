        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === "success") {
              (0, _alert.showAlert)("success", "logged in suucessfully");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("error", "Error in logging you out");
          case 11:
          case "end":
...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var email, password, name, role, passwordConfirm, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            email = _ref.email, password = _ref.password, name = _ref.name, role = _ref.role, passwordConfirm = _ref.passwordConfirm;
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: "POST",
          ...
          case 4:
            result = _context.sent;
            if (result.data.status === "success") {
              (0, _alert.showAlert)("success", "Signup sucessfull");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
...
exports.updateSettings = exports.changePassword = void 0;
var _alert = require("./alert");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe("pk_test_51MJHBsSHelWAwtP5VtSh8IK7BEJCksWhMBWTnVA5WnY8Tn8Pklm18j7A9Ysootc2FuPRYNGOaMrMqkpJAe2kA95p00vkzEEyzi");
...
var bookingTourBtn = document.querySelector("#book");
//DELEGATION
if (formLogin) {
...
if (formSignup) {
  formSignup.addEventListener("submit", function (e) {
    ...
    var password = document.getElementById("password").value;
    var passwordConfirm = document.getElementById("confirm__password").value;
    var role = "user";
    (0, _signup.signup)({
      email: email,
      name: name,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.changePassword)(currentPassword, password, passwordConfirm);
            case 7:
...
if (bookingTourBtn) {
  bookingTourBtn.addEventListener("click", function (e) {
    e.target.textContent = "Processing...";
    var tourId = e.target.dataset.tourId;
    (0, _stripe.bookTour)(tourId);
  });
}
},{"./login":"login.js","./signup":"signup.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
